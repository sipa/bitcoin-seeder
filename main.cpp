...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Credits-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed1.crds.co", "dnsseed2.crds.co", ""};
static const string testnet_seeds[] = {"testnetseed.crds.co", ""};
